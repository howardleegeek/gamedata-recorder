...
impl VideoMetadataExtractor {
    ...
    /// Finalize metadata after recording completes
    pub async fn finalize(
        ...
        metadata.finalize(total_frames, metadata.file_size_bytes, end_time_ns);
        Ok(())
    }
